...
describe('unsigned', function()
  ...
  it('min/max', function()
    ...
    assert.equal("-9223372036854775807", Long.MIN_VALUE:add(1):toString())
    assert.equal("9223372036854775807", Long.MIN_VALUE:subtract(1):toString())
    assert.equal("9223372036854775807", Long.MAX_VALUE:toString())
    assert.equal("-9223372036854775808", Long.MAX_VALUE:add(1):toString())
    assert.equal("9223372036854775806", Long.MAX_VALUE:subtract(1):toString())
